\chapter{Appendix B Endpoints}\label{ch:appB}

\subsection{Account}
This describes all the account endpoints.
...
This describes all the Department endpoints.
...
\subsection{WeekTemplate}
This describes all the WeekTemplate endpoints.
