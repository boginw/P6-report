...
\begin{figure}%
    \centering
    \subfloat[Guardian]{{\includegraphics[width=0.45\textwidth]{figures/Prototypes/WeekPlannerGuardianPrototype.png} }}%
    \quad
    \subfloat[Citizen]{{\includegraphics[width=0.45\textwidth]{figures/Prototypes/WeekPlannerCitizenPrototype.png} }}%
