...
This framework was adopted into the GIRAF Project\cite{ProcessGitFlow}. The biggest differences between the standard GitFlow framework and the GIRAF adaptation are:
