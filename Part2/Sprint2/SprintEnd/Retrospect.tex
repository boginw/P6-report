...
The issues in from the brainstorming that got most three or more votes, were:
\begin{enumerate}
    ...
    \item More sessions where reviewer and auther of a \gls{PR} sits togeather. 
...
Many of the other changes involved small things in the practises. The biggest change was the release preparation changed from four days to one day.\\
