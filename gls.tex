...
\newglossaryentry{skillGroup}{
    name={skill group}, 
    description = {A group formed by one person from each development team. The members of the groups has to have knowledge of the current state of a specific part of the system}
}
...
\newglossaryentry{SOSSprintPlanning}{
    ...
    description = {Planning the sprint for the whole GIRAF development year.}
}
\newglossaryentry{SOSStandUp} {
    name={SOS Stand Up},
    description={Weekly stand up meetings for the whole GIRAF development year}
}
