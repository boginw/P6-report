...
\newglossaryentry{SOSSprintPlanning}{
    ...
    description = {Planning the upcomming sprint for the GIRAF multiproject anno 2019}
}
\newglossaryentry{SOSStandUp} {
    name={SOS Stand Up},
    description={Weekly standup meetings for the GIRAF multiproject anno 2019}
}
...
\newglossaryentry{SOSSprintRetrospective}{
    ...
    description={Sprint Retrospective for the ending sprint in the GIRAF multiproject anno 2019}
}
\newglossaryentry{SOSSprintReview}{
    name={SOS Sprint Review},
    description={The review of the ending sprint in the GIRAF multiproject anno 2019}
}
